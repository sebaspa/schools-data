...
<div class="row">
    <div class="col-12 col-md-6">
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('number_groups') is-invalid @enderror" min="3"
    ...
    <div class="col-12 col-md-6">
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('types') is-invalid @enderror" min="3" id="types" name="types"
