...
<div class="row">
    <div class="col-12 col-md-6">
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('potency') is-invalid @enderror" min="3" id="potency"
    ...
    <div class="col-12 col-md-6">
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('frigoria') is-invalid @enderror" min="3" id="frigoria"
