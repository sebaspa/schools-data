...
@section('content_header')
    <a href="{{ route('airconditionings.create', $school) }}" class="btn btn-sm btn-danger float-right">
                    ...
                    <tbody>
                        @forelse ($airconditionings as $item)
                            <tr>
                                ...
                                <td width="130">
                                    <div class="d-flex">
                                        <a href="{{ route('airconditionings.show', $item) }}"
                                            class="mx-1 btn btn-xs btn-warning">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                        <a href="{{ route('airconditionings.edit', $item) }}"
